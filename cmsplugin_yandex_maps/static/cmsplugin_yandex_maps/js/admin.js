...
function auto_placement(){
	if ($('#id_auto_placement').prop("checked")){
		$('div.form-row.field-zoom').hide();
		$('div.form-row.field-center_lt.field-center_lg').hide();
	} else {
		$('div.form-row.field-zoom').show();
...
function icon_style(elem){
	switch ($(elem).val()){
		case "default":
			$(elem).closest('fieldset').find("div.form-row.field-icon_color").show();
			$(elem).closest('fieldset').find("div.form-row.field-icon_glif").hide();
			$(elem).closest('fieldset').find("div.form-row.field-icon_image").hide();
		...
		case "glif":
			$(elem).closest('fieldset').find("div.form-row.field-icon_color").show();
			$(elem).closest('fieldset').find("div.form-row.field-icon_glif").show();
			$(elem).closest('fieldset').find("div.form-row.field-icon_image").hide();
			$(elem).closest('fieldset').find("div.form-row.field-icon_image label").removeClass('required');
			$(elem).closest('fieldset').find("div.field-box.field-icon_caption").hide();
			$(elem).closest('fieldset').find("div.field-box.field-icon_circle").show();
			...
			break;
		case "image":
			$(elem).closest('fieldset').find("div.form-row.field-icon_color").hide();
			$(elem).closest('fieldset').find("div.form-row.field-icon_glif").hide();
			$(elem).closest('fieldset').find("div.form-row.field-icon_image").show();
			$(elem).closest('fieldset').find("div.form-row.field-icon_image label").addClass('required');
			$(elem).closest('fieldset').find("div.field-box.field-icon_caption").show();
			$(elem).closest('fieldset').find("div.field-box.field-icon_circle").hide();
			$(elem).closest('fieldset').find("div.form-row.field-icon_width.field-icon_heigt").show();
